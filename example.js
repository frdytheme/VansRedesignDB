 ...
 */
app.get("/", (req, res) => {
  res.send("노드 익스프레스로 json api 만들기");
});
...
/**
 * @path {GET} http://localhost:5000/api/users/user?user_id=1
...
/**
 * @path {GET} http://localhost:5000/api/users/userBody
...
/**
 * @path {GET} http://localhost:5000/api/users/:user_id
...
/**
 * @path {POST} http://localhost:5000/api/users/add
...
/**
 * @path {PUT} http://localhost:5000/api/users/update
...
/**
 * @path {PATCH} http://localhost:5000/api/user/update/:user_id
...
/**
 * @path {DELETE} http://localhost:5000/api/user/delete
 * @description 데이터 삭제
 *
 */
...
app.listen(5000, () => console.log("노드 익스프레스로 json api 만들기"));
